    ...
    <div className="footer">
      ...
      <div className="features2">
        <ul className="features2">
          <li>
            <a href="#Our_container2-service">Our services</a>
          </li>
          <li>
      ...
      <div className="socmed">
        ...
        <div className="soc-icon">
          ...
          <a href="https://www.instagram.com/academybinar/?hl=id">
            <svg
              className="insta"
              width="32"
              height="32"
          ...
          <a href="https://twitter.com/academybinar?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor">
            <svg
              className="twitt"
              width="32"
              height="32"
